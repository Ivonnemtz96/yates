...
<section class="fact-counter-area thm_bgclr3">
    <div class="container">
        <div class="row">
            ...
            <!--Start Single Fact Counter-->
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="single-fact-counter text-left wow fadeInLeft" data-wow-delay="500ms"
                    data-wow-duration="1500ms">
                    <div class="count-box">
                        <h1>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="discover-content text-center">
                    ...
                    <h1 class="wow slideInDown" data-wow-delay="100ms">Yacher is a World Leading<br> Online Yachtcharter
                        Platform</h1>
